"""Scrape AliExpress category pages for product listings."""
...
async def find_aliexpress_products(url: str, max_pages: int = None) -> List[Dict]:
    ...
    total_pages = first_page_data["total_pages"] - 1

    if max_pages is None:
        max_pages = total_pages
    print(f"found {total_pages} pages, but only scraping {max_pages} pages")
